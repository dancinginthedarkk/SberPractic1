...
const descriptions: Record<string, string> = {
  ...
  'Переговорные комнаты':
    'В нашем офисе находятся современные и функциональные переговорные комнаты, созданные для обеспечения эффективной и продуктивной работы наших сотрудников. Каждая переговорная комната названая в честь морей Росси. В них есть всё необходимое для комфортного общения и презентаций: от профессионального оборудования для видеоконференций, интерактивных досок до удобных столов и стульев.',
  'Игровая комната':
